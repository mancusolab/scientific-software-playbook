...
**Phase 6: Planning handoff.** The design plan is committed to git. The system provides the next command:

```
/start-implementation-plan docs/design-plans/2026-02-27-ldsc-jax-port.md
```
