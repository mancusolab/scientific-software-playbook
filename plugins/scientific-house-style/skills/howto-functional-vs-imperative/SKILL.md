...
metadata:
  short-description: Functional core / imperative shell
---
...
- Claude plugin installation example: `<claude-plugin-root>/skills/howto-functional-vs-imperative/SKILL.md`
