...
description: Compatibility wrapper for the canonical executing-an-implementation-plan lifecycle skill.
...
Use `executing-an-implementation-plan` as the canonical execution workflow.
