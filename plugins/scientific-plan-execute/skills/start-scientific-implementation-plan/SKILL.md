...
description: Compatibility wrapper for the canonical starting-an-implementation-plan lifecycle skill.
...
Use `starting-an-implementation-plan` as the canonical implementation-planning workflow.
