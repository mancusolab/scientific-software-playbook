...
```bash
grep -i "worktree.*director\\|worktree.*directory" AGENTS.md CLAUDE.md 2>/dev/null
```
...
2. ~/.codex/worktrees/<project-name>/ (global, Codex)
3. ~/.claude/worktrees/<project-name>/ (global, Claude)
...
### For Global Directory (~/.codex/worktrees or ~/.claude/worktrees)
...
**Called by:**
- **starting-a-design-plan** - when implementation is expected and isolation is preferred
- **start-implementation-plan** - when branch/worktree constraints require isolation
- Any skill needing isolated workspace

**Pairs with:**
- **execute-implementation-plan** - phase execution happens in this worktree
