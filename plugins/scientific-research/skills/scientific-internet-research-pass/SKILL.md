...
- Claude plugin installation example: `<claude-plugin-root>/skills/scientific-internet-research-pass/SKILL.md`
...
Gather accurate, current, well-sourced information from the internet to inform planning and design decisions. Test hypotheses, verify claims, and find authoritative sources for APIs, libraries, scientific methods, and best practices.
...
- Verifying technical/scientific claims or assumptions
- Researching library comparison and alternatives
- Finding best practices and current community consensus
- Finding scientific literature support for proposed models/approaches

**Don't use for:**
- Information already in codebase (use codebase search)
- General knowledge within the model's training (answer directly)
...
| **Library comparison** | Official sites -> package registry stats -> GitHub activity |
...
| **Scientific support** | Papers/specs -> methods docs -> reference implementations |

## Source Evaluation Tiers

| Tier | Sources | Usage |
|------|---------|-------|
| **1 - Most reliable** | Official docs, release notes, changelogs, papers/specs | Primary evidence |
...
**Multiple approaches:**
- For literature-heavy questions, prefer ScholarAI when available for paper discovery and metadata grounding.
...
- For paper-backed claims, include DOI/venue/year when available and note if ScholarAI was unavailable.
