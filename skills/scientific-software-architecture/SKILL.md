...
2. Plan creation command/skill: `commands/new-design-plan.md` or `skills/new-design-plan/SKILL.md`
3. Readiness validation command/skill: `commands/validate-design-plan.md` or `skills/validate-design-plan/SKILL.md`
4. Status transition command/skill: `commands/set-design-plan-status.md` or `skills/set-design-plan-status/SKILL.md`
5. Plan template: `docs/design-plans/templates/scientific-architecture-plan-template.md`
6. Model artifacts templates:
...
7. Review template: `docs/reviews/review-template.md`
8. Implementation orchestration:
- `commands/start-scientific-implementation-plan.md` or `skills/start-scientific-implementation-plan/SKILL.md`
- `commands/execute-scientific-implementation-plan.md` or `skills/execute-scientific-implementation-plan/SKILL.md`
- `docs/implementation-plans/templates/`
9. External research pass:
